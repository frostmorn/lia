#ifndef YES_COMMAND_J
#define YES_COMMAND_J
function YesCommandTriggerCallback takes nothing returns nothing
    ...
    set vv[bs]=vv[Xq]
    set vv[Xq]=ED
    set ED=CreepsKilledByPlayer[bs]
    set CreepsKilledByPlayer[bs]=CreepsKilledByPlayer[Xq]
    set CreepsKilledByPlayer[Xq]=ED
    set ED=Qv[bs]
    set Qv[bs]=Qv[Xq]
    set Qv[Xq]=ED
    set ED=Re[bs]
