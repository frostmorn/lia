...
function CreateTriggers takes nothing returns nothing
    ...
    call TriggerAddAction(SetCameraCommandTrigger,function SetCamera_Trigger_Function)
    ...
    #endif
    call TriggerAddAction(HelpCommandTrigger,function RQ)
    ...
    call TriggerAddAction(CLSCommandTrigger,function uQ)
    call TriggerAddAction(EnableTestModeTrigger,function EnableTestMode)
    call TriggerAddAction(kR,function yQ)
    call TriggerAddAction(TestModeLevelCommandTrigger,function ZQ)
    ...
    call TriggerAddAction(SwitchCommandTrigger,function Xs)
    call TriggerAddAction(YesCommandTrigger,function Ns)
    call TriggerAddAction(NoCommandTrigger,function Cs)
    call TriggerAddAction(StopSwitchCommandTrigger,function fs)
    call TriggerAddAction(uR,function gs)
    call TriggerAddAction(Swap2CommandTrigger,function hs)
    call TriggerAddAction(SwapCommandTrigger,function js)
    call TriggerAddAction(RepickCommandTrigger,function Ms)
