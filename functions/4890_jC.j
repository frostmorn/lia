...
set NeutralBuildings[1]=CreateUnitAtLoc(p,'n004',GetRectCenter(gg_rct_Zr),Ec)
set NeutralBuildings[2]=CreateUnitAtLoc(p,'n00C',GetRectCenter(gg_rct_vi),Ec)
set NeutralBuildings[3]=CreateUnitAtLoc(p,'n005',GetRectCenter(gg_rct_ei),Ec)
set NeutralBuildings[4]=CreateUnitAtLoc(p,'n006',GetRectCenter(gg_rct_xi),Ec)
set NeutralBuildings[5]=CreateUnitAtLoc(p,'n01J',GetRectCenter(gg_rct_oi),Ec)
set NeutralBuildings[6]=CreateUnitAtLoc(p,'n02F',GetRectCenter(gg_rct_ni),Ec)
set NeutralBuildings[7]=CreateUnitAtLoc(p,'n014',GetRectCenter(gg_rct_ri),Ec)
set NeutralBuildings[8]=CreateUnitAtLoc(p,'n001',GetRectCenter(gg_rct_ii),Ec)
// Fountain of Health
// set NeutralBuildings[9]=CreateUnitAtLoc(p,'n00A',GetRectCenter(gg_rct_ai),Ec)
set GI=true
call SetUnitAnimation(NeutralBuildings[1],"work")
call SetUnitAnimation(NeutralBuildings[2],"work")
call SetUnitAnimation(NeutralBuildings[3],"work")
call SetUnitAnimation(NeutralBuildings[4],"work")
call SetUnitAnimation(NeutralBuildings[5],"work")
call SetUnitAnimation(NeutralBuildings[6],"work")
call SetUnitAnimation(NeutralBuildings[7],"work")
call SetUnitAnimation(NeutralBuildings[8],"work")
// call SetUnitAnimation(NeutralBuildings[9],"work")
set p=null
set u=null
endfunction
